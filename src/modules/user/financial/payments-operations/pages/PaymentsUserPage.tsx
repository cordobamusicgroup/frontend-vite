        ...
        <>
          ...
          <InformativeBox collapsible>
            ...
            <ul style={{ margin: 0, paddingLeft: '1.5rem' }}>
              <li>
                <Typography variant="body2">
                  Payments are typically credited to your account between the <b>15th and 30th of each month</b>, depending on when funds are received and processed by our banking partners. Please
                  note that external factors may occasionally cause delays.
                </Typography>
              </li>
            </ul>
            <Typography variant="body2" sx={{ mt: 2, fontStyle: 'italic' }}>
              * All dates and amounts are approximate and subject to change. We kindly ask that you do not contact support solely to inquire about payment dates or recent transactions unless there is
              an urgent issue.
            </Typography>
          </InformativeBox>
